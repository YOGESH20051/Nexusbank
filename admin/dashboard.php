...
<div class="quick-actions-v2">
    ...
    <div class="qa2-list">
        ...
        <a href="add_user.php" class="qa2-btn green">➕ Add User</a>
        <a href="approve-users.php" class="qa2-btn emerald">✔ Approve Accounts</a>
        <a href="all-transactions.php" class="qa2-btn blue">💸 View Transactions</a>
        <a href="loan-history.php" class="qa2-btn sky">🏦 Loan Requests</a>
        <a href="add_news.php" class="qa2-btn yellow">📰 Post Bank News</a>
        <a href="admin/contact-messages.php" class="qa2-btn purple">📨 Contact Inbox</a>

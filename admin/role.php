        ...
        <aside class="sidebar">
            ...
            <nav class="dashboard-nav">
               ...
               <a href="manage-users.php" class="btn">
                ...
                <a href="role.php" class="btn dash-text">
                        <img 
                        src="../assets/images/rolesactive_logo.png" 
                        alt="role-logo" 
                        class="nav-icon"
                        data-default="../assets/images/roles_logo.png"
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php if (isset($_GET['success'])): ?>
                                    ...
                                    <p style="color: red;">You cannot change your own admin role.</p>
                                    <?php endif; ?>
                            <?php foreach ($users as $user): ?>
                                <tr>
                                    ...
                                    <td data-label="Role">
    <form method="POST" action="update-role.php" class="role-form">
